...
import type { FocusEventHandler, PointerEventHandler, Ref, RefAttributes, RefObject } from "react";
...
const ComboBoxValue = ({ size, shortcut, placeholder, shortcutClassName, ref, ...otherProps }: ComboBoxValueProps) => {
